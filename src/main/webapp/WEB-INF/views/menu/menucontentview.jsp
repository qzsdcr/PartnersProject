	...
	<form action="menucontentupdate" method="post">
		...
		<table>
			...
			<tr>
				...
				<td><fmt:formatDate value="${menucontent_view.menudate}"
			...
			<tr>
				<td class="left">첨부</td>
				<td><a
					href="download?p=resources/upload/&f=${menucontent_view.menufilesrc}&bid=${menucontent_view.menuid}">
						${menucontent_view.menufilesrc}</a></td>
			</tr>
			<tr>
				<td colspan="2"><input type="submit" value="수정폼으로" />&nbsp;&nbsp;
					<a href="menulist">목록</a> &nbsp;&nbsp; <a
					href="menudelete?menuid=${menucontent_view.menuid}">삭제</a>
					&nbsp;&nbsp;</td>
			</tr>
		</table>
	</form>
