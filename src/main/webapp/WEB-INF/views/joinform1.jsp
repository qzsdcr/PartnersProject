...
<body>
	<div class="container">
		<div class="input-form-background row">
			<div class="input-form col-md-12 mx-auto">
				...
				<div class="row">
					 <div class="col-md-6 mb-3">
					   ...
					   <input type="text" name="mememail" class="form-control" id="mememail" placeholder="example@example.com" required>
					   <div class="invalid-feedback">이메일 인증번호를 입력해주세요</div>
					 </div>
					<div class="col-md-6 mb-3" style="margin-top: auto;" style="margin-bottom: auto;">
					  <button type="button" class="btn btn-primary" style="width: 100%;" id="get_auth_num" onclick="handleButtonClick()">인증번호 받기</button>
					</div>
				</div>		
				...
				<div class="row">
					 ...
					 <div class="col-md-6 mb-3" style="margin-top: auto;" style="margin-bottom: auto;">
					  <button type="button" class="btn btn-primary" style="width: 100%;" id="mail_auth_button">메일 인증</button>
					</div>
				</div>
          ...
          <div class="mb-3 checkbox-control">
					...
					<div class="row">
					    <div class="col-md-6 mb-3">
					        ...
					        <select name="memaddress" class="form-control">
					            ...
					            <option value="광명">광명</option> <!-- 중복된 값 제거 -->
					        </select>
					    </div>
					    <div class="col-md-6 mb-3">
						...
						<div class="form-group row">
							<div class="col-8 offset-4">
								...
								<p>
									...
									<input type="checkbox" class="custom-control-input" id="aggrement" name="aggrement"	required="required"> 
										<label	class="custom-control-label" for="aggrement">
										<a id="aggrement" href="javascript:agree();" data-bs-toggle="modal" data-bs-target="#modal">개인정보취급방침</a>에 동의하십니까? </label>
								</p>
							</div>
							<!-- 개인정보방침 modal창 내용 -->
...
function handleButtonClick() {
  ...
  $.ajax({
	  ...
	  success: function(tempkey){
		  ...
		  tempkey = data.tempkey; // tempkey 전역변수에 저장
