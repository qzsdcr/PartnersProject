...
<body>
	...
	var glList = JSON.parse('${gllistJson }');
	
	var positions = [];
	
	$(glList).each(function(i,v){
		let obj = {};
		obj.title = v.sikname;
		obj.address = v.sikaddress;
		positions.push(obj);
	});
	...
	function setBounds() { //추가한 함수
	    ...
	    map.setBounds(bounds);
				...
				<div class="box">
					...
					<form action="gulo" method="post" style="text-align: center;">
						...
						<c:forEach begin="${searchVo.pageStart }"
							...
							<c:choose>
								...
								<c:otherwise>
									<a
										href="gulo?page=${i }&sikloca=${sikloca }&sikcon=${sikname }&sk=${resk }&com=구로"
