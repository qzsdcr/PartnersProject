					...
					<form action="gasan" method="post" style="text-align: center;">
						...
						<c:forEach begin="${searchVo.pageStart }"
							...
							<c:choose>
								...
								<c:otherwise>
									<a
										href="pangyo?page=${i }&sikloca=${sikloca }&sikcon=${sikname }&sk=${resk }&com=판교"
						...
						<c:if test="${searchVo.page<searchVo.totPage }">
							<a href="pangyo?page=${searchVo.page+1 }&com=판교">[다음]</a>
							<a href="pangyo?page=${searchVo.totPage }&com=판교">[마지막]</a>
						</c:if>
					</form>
