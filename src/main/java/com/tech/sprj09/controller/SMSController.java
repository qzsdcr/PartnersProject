...
public class SMSController {
    ...
    public SMSController() {
        ...
        this.messageService = NurigoApp.INSTANCE.initialize("NCSOKP99RCNRTXNQ", "ONVJ1OY2LZ6WWWTOVJ14VUZJZ5YH73RH", "https://api.coolsms.co.kr");
    }
    ...
    public String sendOne(HttpServletRequest request, AdminSearchVO adminsearchVO, Model model) {
        Message message = new Message();
        
        model.addAttribute("request", request);
        
      //  bServiceInter=new CallService(sqlSession);
        
        String mempnum=request.getParameter("mempnum");
        String smstext=request.getParameter("smstext");
        
        // 발신번호 및 수신번호는 반드시 01012345678 형태로 입력되어야 합니다.
        message.setFrom("01049362481");//admin 발신번호
        message.setTo(mempnum);//수신번호
